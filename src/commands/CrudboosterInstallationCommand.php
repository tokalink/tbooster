...
class CrudboosterInstallationCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if ($this->confirm('Do you have setting the database configuration at .env ?')) {
            ...
            $process = \method_exists(\Symfony\Component\Process\Process::class, 'fromShellCommandline')
                ? \Symfony\Component\Process\Process::fromShellCommandline($composer.' dump-autoload')
                : new \Symfony\Component\Process\Process([$composer, 'dump-autoload']);
